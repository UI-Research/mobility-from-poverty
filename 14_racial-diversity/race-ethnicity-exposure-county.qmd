...
if(!file.exists(here::here("14_racial-diversity/data/tracts.csv"))){
  ...
  write_csv(tracts_raw, here("14_racial-diversity/data/tracts.csv"))
}
```
...
tracts_raw <- read_csv(here("14_racial-diversity/data/tracts.csv"))
```
...
county_data %>%
  ...
  write_csv(here::here("14_racial-diversity", "final", "race-ethnicity-exposure-county.csv"))
```
...
evaluate_final_data(
  exp_form_path = "99a_final-evaluation/evaluation_form_share_race_exposure_overall_county.csv",
