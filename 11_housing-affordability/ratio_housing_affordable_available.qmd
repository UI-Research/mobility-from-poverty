...
warning("This geography universe listing is modified here because, at the time
        ...
        that were used in years preceding 2022 (except that in 2014, it does reflect these counties. 
        However, in future updates, the original universe file should be updated, and this manual modification should be removed.")
  ...
  {if (geography == "county") 
    mutate(.,
      geography_count = case_when(
        year < 2022 & year > 2014 ~ geography_count + 8,
