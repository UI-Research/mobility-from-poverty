...
```{r}
final_data_dis <- read_csv(here("08_education/data/final/metrics_college_county_disability_longitudinal.csv"), show_col_types = FALSE)

final_data_gender <- read_csv(here("08_education/data/final/metrics_college_place_gender_longitudinal.csv"), show_col_types = FALSE)
