...
```{r}
airtox_data19 <- map_df(list.files(here::here("19_environmental-quality/data/raw/2019/")), 
~read_excel(paste0(here::here("19_environmental-quality/data/raw/2019"), "/", .x))) %>% 
  clean_names() %>% 
  mutate(year = "2019")
  
airtox_data18 <- map_df(list.files(here::here("19_environmental-quality/data/raw/2018/")), 
~read_excel(paste0(here::here("19_environmental-quality/data/raw/2018"), "/", .x))) %>%  
  clean_names() %>% 
  mutate(year = "2018")

airtox_data14 <- map_df(list.files(here::here("19_environmental-quality/data/raw/2014/")), 
~read_excel(paste0(here::here("19_environmental-quality/data/raw/2014"), "/", .x))) %>% 
  clean_names() %>% 
  mutate(year = "2014")
```
...
```{r}
write_csv(final_data_county_all, here::here("19_environmental-quality", "data", "final", "environment_county_longitudinal.csv"))

county_sub_pov <- final_data_county_sub %>% 
  filter(subgroup_type %in% c("all", "poverty"))

write_csv(county_sub_pov, here::here("19_environmental-quality", "data", "final", "environment_county_poverty_longitudinal.csv"))

county_sub_race <- final_data_county_sub %>% 
  filter(subgroup_type %in% c("all", "race-ethnicity"))

write_csv(county_sub_race, here::here("19_environmental-quality", "data", "final", "environment_county_race-ethnicity_longitudinal.csv"))
```
...
write_csv(final_data_place_all, here::here("19_environmental-quality", "data", "final", "environment_place_longitudinal.csv"))

final_data_place_pov <- final_data_place %>% 
  filter(subgroup_type %in% c("all", "poverty"))

write_csv(final_data_place_pov, here::here("19_environmental-quality", "data", "final", "environment_place_poverty_longitudinal.csv"))

final_data_place_race <- final_data_place %>% 
  filter(subgroup_type %in% c("all", "race-ethnicity"))

write_csv(final_data_place_race, here::here("19_environmental-quality", "data", "final", "environment_place_race-ethnicity_longitudinal.csv"))
```
