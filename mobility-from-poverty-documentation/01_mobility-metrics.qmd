...
**Year:** `r get_years(mm_longitudinal, var = share_affordable_30_ami, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = homeless_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = poverty_exposure_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = black_nh_exposure_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = transit_trips_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = learning_rate_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = hs_degree_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = employed_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = wage_ratio_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = pctl_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = share_debt_coll_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = lbw_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = environmental_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = election_turnout_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = asian_other_quality, max = TRUE)`
...
**Year:** `r get_years(mm_longitudinal, var = juvenile_arrest_rate_quality, max = TRUE)`
