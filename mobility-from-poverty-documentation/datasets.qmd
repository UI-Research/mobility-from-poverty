# Available Data Sets {.unnumbered}
...
# 02_mobility-metrics_race-ethnicity.csv

* **Unit of Observation:** One row per county per race-ethnicity group.
* **Dimensions:** `r dimensions(mm_race_ethnicity)`

---

# 03_mobility-metrics_race.csv

* **Unit of Observation:** One row per county per race group.
* **Dimensions:** `r dimensions(mm_race)`

---

# 04_mobility-metrics_race-share.csv

* **Unit of Observation:** One row per county per majority race group in a subgeography.
* **Dimensions:** `r dimensions(mm_race_share)`

---

The following sections provide detailed documentation for each data set.
