...
metrics_employment_sub %>% 
  ...
  facet_wrap(~subgroup) +
  labs(
    title = "Distribution of share employed, race/ethnicity, by county 2021 (5-year data)",
    y = "Density"
  ) +
  theme_minimal()
...
metrics_employment_sub %>% 
  ...
  facet_wrap(~subgroup) +
  labs(
    title = "Distribution of share employed, gender, by county 2021 (5-year data)",
    y = "Density"
  ) +
  theme_minimal()
```
...
metrics_employment_sub %>% 
  ...
  facet_wrap(~subgroup) +
  labs(
    title = "Distribution of share employed, disability, by county 2021 (5-year data)",
    y = "Density"
  ) +
  theme_minimal()
