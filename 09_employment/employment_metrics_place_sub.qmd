...
}else{write_csv(paste0(here::here("09_employment", "data", "intermediate"), 
...
evaluate_final_data(data = metrics_employment_race, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_employment_race_eth_place.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_employment_gender, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_employment_gender_place.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
```
...
evaluate_final_data(data = metrics_employment_disability, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_employment_disability_place.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
