...
if(isTRUE(bucket_exists(bucket = my_bucket))){
 if (!aws.s3::object_exists(paste0(s3_dir, "/metrics_employment_all", "_", params$year[1], ".csv"), bucket = my_bucket)){
    ...
    put_object(tmp, object = paste0(s3_dir, "/metrics_eployment_all", "_", params$year, ".csv"), bucket = my_bucket, 
