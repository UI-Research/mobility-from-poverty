...
local crosswalk "C:\Users\KMartinchek\Documents\upward-mobility-2025\mobility-from-poverty\geographic-crosswalks\data"
/*
...
*log using "$raw\temp-qecw-log.log", replace

** need to fix assert for ALL YEARS-- annualaveragestatuscode **
** seems like i did for 2022??
** but its mostly issues with professional services and public administration categories in 2023-- need to look into this
...
foreach year in /*2015 2016 2017 2018 2019 2020 2021*/ /*2022*/ 2023 {
	...
	import delimited using "$raw/2023_data.csv", numericcols(14 15 16 17 18) varnames(1) clear
