---
title: "Employment Opportunities Predictor, place, subgroups"
author: "JP Walsh"
date: today
format:
  html:
...
*Program for the creation of the Employment Opportunities Predictor, subgroups, place level*
...
if(!file.exists(here::here("09_employment", "data", "raw", "employment_opp_5year.dat.gz"))){
    ...
    usa_ext_umf <-
      define_extract_usa(
        description = "5-year ACS microdata pull for the Employment Opportunities Predictor at the place level, subgroups",
        samples = c("us2021c"),
         variables = list(
      "ADJUST",
      "STATEFIP",
...
```{r}
write_csv(acs2021clean, here::here("09_employment", "data", "intermediate", "2021microdata_subgroup.csv"))
...
Look at distributions of employment share by place for each subgroup category.
...
Read in the employment share variable for all households in the place.

```{r}

employment_all <- read_csv(here::here("09_employment", "data", "final", "metrics_employment_city_2021.csv"))
...
write_csv(metrics_employment, here::here("09_employment", "data", "final", "metrics_employment_city_subgroup_2021.csv"))
