...
if(isTRUE(bucket_exists(bucket = my_bucket))){
 if (!aws.s3::object_exists(paste0(s3_dir, "/metrics_education_all_county", "_", params$year[1], ".csv"), bucket = my_bucket)){
...
```{r}
 if(isTRUE(bucket_exists(bucket = my_bucket))){
   if (!aws.s3::object_exists(paste0(s3_dir, "/metrics_education_sub_county", "_", params$year, ".csv"), bucket = my_bucket)){
...
write_csv(
  metrics_education_all, 
  file = here::here("08_education", "data", "final", "metrics_preschool_county_all_longitudinal.csv")
)
...
write_csv(metrics_education_race, here::here("08_education", "data", "final", "metrics_preschool_county_race-ethnicity_longitudinal.csv"))
...
write_csv(metrics_education_income, here::here("08_education", "data", "final", "metrics_preschool_county_income_longitudinal.csv"))
