...
evaluate_final_data(data = metrics_education_all, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_preschool_overall_place.csv"), geography = "place", subgroups = FALSE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_education_race, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_preschool_race_eth_place.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_education_income, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_preschool_income_place.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
...
write_csv(metrics_education_all, 
          here::here("08_education", "data", "final", "metrics_preschool_place_all_longitudinal_all.csv")
          )
