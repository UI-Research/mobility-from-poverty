...
*uses first name of metros
gen city_name2 = substr(sedametroname, 1, strpos(sedametroname,"-")-1)
replace city_name2 = city_name if city_name2==""
drop city_name
rename city_name2 city_name
