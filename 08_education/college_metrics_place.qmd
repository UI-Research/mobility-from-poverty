...
read_intermediate <- function(year, file_type){
  ...
  read_csv(paste0(here::here("08_education", "data", "intermediate", "college"), 
...
evaluate_final_data(data = metrics_education_all_clean, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_college_overall_place.csv"), geography = "place", subgroups = FALSE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_education_race, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_college_race_eth_county.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
```
...
evaluate_final_data(data = metrics_education_gender, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_college_gender_county.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
```
...
evaluate_final_data(data = metrics_education_disability, exp_form_path = here::here("10a_final-evaluation", "evaluation_form_college_disability_county.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
```
