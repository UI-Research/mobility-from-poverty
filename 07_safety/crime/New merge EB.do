...
cd "D:\Users\EBlom\Box Sync\Metrics Database\Safety\crime_rate"
...
drop if city_name == ""
*/
keep place_name state_name countystate afact
replace place_name = substr(place_name, 1, strlen(place_name)-4)
rename place_name city_name
drop if city_name==""
gen idusing = _n

save city_to_county_geocorr_EB, replace
