...
sum coverage_indicator_jjarrest
gen juvenile_arrest_rate_quality = .
replace juvenile_arrest_rate_quality = 1 if coverage_indicator_jjarrest == 1 & coverage_indicator_jjarrest != .
replace juvenile_arrest_rate_quality = 2 if coverage_indicator_jjarrest < 1 & coverage_indicator_jjarrest >= 0.8 & coverage_indicator_jjarrest != .
replace juvenile_arrest_rate_quality = 3 if coverage_indicator_jjarrest < 0.8 & coverage_indicator_jjarrest != .
replace juvenile_arrest_rate_quality = 3 if juvenile_arrest_rate > 100000 & coverage_indicator_jjarrest != .
