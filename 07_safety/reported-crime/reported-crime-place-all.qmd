...
Note [this article](https://www.al.com/news/mobile/2023/06/mobile-no-longer-listed-as-second-most-dangerous-city-in-the-us-after-fbi-corrects-data.html) indicates the data for Mobile City, Alabama was bad, so we change the data quality flag. 
```{r}
rates_place %>%
...
write_csv(
  ...
  file = here::here("07_safety", "modified data", "rates_crime_place_all.csv")
)
