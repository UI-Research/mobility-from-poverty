...
```{r load-geocorr-xw}
# The crosswalk was split into pre/post-2022 versions to handle Connecticut's
# county-to-planning-region change. We use the 2022-onwards version since it
# covers the majority of our data years (2022-2024).
county_place_xw <- read_csv(here::here("geographic-crosswalks", "data", "geocorr2022_county_place_2022_onwards.csv"))
