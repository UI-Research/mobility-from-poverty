...
5. Move the files for 2021-2024 to the `mobility-from-poverty/07_safety/data/offense-segment` directory.
...
```{r read-offense-function, eval=FALSE}
...
offenses_agency <- bind_rows(offenses_21_agency, offenses_22_agency, offenses_23_agency, offenses_24_agency)
...
write_csv(offenses_agency, file = here::here("07_safety", "data", "offense-segment", "offenses_agency_place.csv"))
```

```{r read-appended-offenses}
offenses_agency <- read.csv(here::here("07_safety", "data", "offense-segment", "offenses_agency_place.csv"))
