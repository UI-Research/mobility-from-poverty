...
REVIEWER - this section could probably be turned into a function, but everything I tried resulted in memory/storage issues.
...
I'm not sure why there are unmatched observations in the `offenses_agency` file. Theoretically, because an agency included in the Offense Segment is by definition included in the Batch Header Segment, all of these observations should match onto the Batch Header Segment.
```{r}
