...
We get arrest counts from two segments of the NIBRS: the Arrestee Segment and the Group B Arrest Report Segment. These are mutually exclusive observations; [a single arrest cannot be in both segments](https://ucrbook.com/arrestee.html).
