...
The Batch Header File is available as a single file covering all years on both Harvard Dataverse and ICPSR. For the 2026 metric update, we used the ICPSR version (`batch_header_rds_1991_2024.zip` from V11) which includes 2024.

Manually downloading these data is a three-step process:

  1. Navigate to [Kaplan's NIBRS data on ICPSR](https://www.openicpsr.org/openicpsr/project/118281).
  2. Download `batch_header_rds_1991_2024.zip`. Complete the license/data use agreement.
  3. Unzip and move `nibrs_batch_header_1991_2024.rds` to the `mobility-from-poverty/07_safety/data` directory.
...
batch_header_file_full <- readRDS(here::here("07_safety", "data", "nibrs_batch_header_1991_2024.rds")) |>
