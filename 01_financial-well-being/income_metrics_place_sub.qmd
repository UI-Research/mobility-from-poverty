...
results_all <- finalize_metric(results_all, .geo_level = place) 
...
results_race_ethnicity <- finalize_metric(results_race_ethnicity, .geo_level = place)
...
write_csv(metrics_income_sub, here::here("01_financial-well-being", "data", "final", "metrics_income_place_subgroups_longitudinal.csv"))
