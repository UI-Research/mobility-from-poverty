...
metrics_income_sub %>% 
  ...
  facet_wrap(~subgroup) +
  labs(
    title = "Income percentiles, race/ethnicity, by county 2021 (5-year data)",
    y = "Density"
  ) +
  theme_minimal()
```
...
write_csv(metrics_income_sub, here::here("01_financial-well-being", "final", "metrics_income_county_race-ethnicity_longitudinal.csv"))
```
