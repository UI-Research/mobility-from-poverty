...
metrics_income_all <- acs_clean %>%
  ...
  summarise(
    pctl_income_20 = Hmisc::wtd.quantile(hhincome, weights = hhwt, probs = 0.2, type = "i/n"),
    pctl_income_50 = Hmisc::wtd.quantile(hhincome, weights = hhwt, probs = 0.5, type = "i/n"),
    pctl_income_80 = Hmisc::wtd.quantile(hhincome, weights = hhwt, probs = 0.8, type = "i/n")
  ) %>%
  ungroup() 
```
