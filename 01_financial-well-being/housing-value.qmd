...
options(scipen = 999)
librarian::shelf(tidyverse, ipumsr, here, glue, labelled, skimr, urbnthemes, tidylog, assertr)
...
export_metric <- function(data, file_type) {
  ...
  output_path <- here(glue("01_financial-well-being/data/final/households_house_value_race_ethnicity_{file_type}_{geography}.csv"))
