...
# the previous chunk is called. In my case it is, "usa_00012.xml" but that will
# be different for you.
microdata <- "usa_00012.xml"
...
For pre-2022 ACS data, we use a crosswalk from 2012 PUMA to 2014 county.
...
# Should the population variable that determines quality be the total population or the population of homeowners? Currently, we're basing it off the population of homeowners,
# which is stricter. This causes more observations to have a data quality flag value of 3
# compared to the geographic_allocation_quality variable in the puma county crosswalk file.
house_value_county <-
  house_value_county |>
