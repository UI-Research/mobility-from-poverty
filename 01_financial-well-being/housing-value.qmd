  ...
  if (file_type == "subgroup") {
    if (geo_var == "county") {
      ...
      data <-
        ...
        full_join(missing_geo, by = c("year", "state", "place", "state_name", "place_name", "subgroup")) |>
        mutate(subgroup_type = "age", .before = "subgroup") |>
    ...
    data <-
      data |>
      group_by(year, state, {{ geo_var }}) %>%
      fill(state_name, str_glue(geo_var, "_name"), .direction = "downup") %>%
      ungroup()
  }
