...
For 2022 ACS and onward we use a crosswalk going from 2020 PUMA to 2020 Place. For pre-2022 ACS data, we use a crosswalk from 2012 PUMA to 2014 Place.
...
Add Age subgroup (max 2 groups) - Jung Choi suggested age 45 as the split, so something like <age 45 and 45+
