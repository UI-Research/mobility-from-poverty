...
```{r}
metrics_income_all <- metrics_income_all %>% 
  select(year, statefip, county, pctl_income_20, pctl_20_quality, 
...
```{r}
metrics_income_sub <- metrics_income_sub %>% 
  select(year, statefip, county, subgroup_type, subgroup, pctl_income_20, pctl_20_quality, 
         pctl_income_50, pctl_50_quality, pctl_income_80, 
         pctl_80_quality)
```
...
```{r}
metrics_income_all <- metrics_income_all %>% 
  select(year, state, county, pctl_income_20, pctl_20_quality, pctl_income_50, 
         pctl_50_quality, pctl_income_80, pctl_80_quality)

metrics_income_sub <- metrics_income_sub %>% 
  select(year, state, county, subgroup_type, subgroup, pctl_income_20, pctl_20_quality, pctl_income_50, 
         pctl_50_quality, pctl_income_80, pctl_80_quality)
```
