...
```{r}
metrics_income <- left_join(metrics_income, county_puma, by=c("crosswalk_period", "statefip","county"))
```
...
write_csv(metrics_income, here::here("01_financial-well-being", "data", "final", "metrics_income_county.csv"))
