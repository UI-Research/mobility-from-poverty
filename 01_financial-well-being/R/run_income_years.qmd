...
reports <-
  tibble(
    input = here::here("01_financial-well-being", "income_metrics_place_all.qmd"),
    output_file = glue::glue("calculate-income-place-{years}.html"),
...
reports <-
  tibble(
    input = here::here("01_financial-well-being", "income_metrics_county_all.qmd"),
    output_file = glue::glue("calculate-income-county-{years}.html"),
    execute_params = map(years, ~ list(year = .))
  )
