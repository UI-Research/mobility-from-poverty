  ...
  mutate(
    council_asian_other = 
      if_else(condition = council_members == 0, 
              true = as.numeric(NA), 
              false = council_asian_other / council_members),
    council_black_nonhispanic = 
      if_else(condition = council_members == 0, 
              true = as.numeric(NA), 
              false = council_black_nonhispanic / council_members),
    council_hispanic = 
      if_else(condition = council_members == 0, 
              true = as.numeric(NA), 
              false = council_hispanic / council_members),
    council_white_nonhispanic = 
      if_else(condition = council_members == 0, 
              true = as.numeric(NA), 
              false = council_white_nonhispanic / council_members)
  )
