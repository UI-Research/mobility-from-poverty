...
county_pop_by_race <- county_pop_by_race %>% 
  select(year, state, county, total_people, total_nonhispanic = total_nonhisp, 
         asian_other, black_nonhispanic, hispanic = total_hispanic, white_nonhispanic,
         total_people_quality, total_nonhispanic_quality = total_nonhisp_quality, asian_other_quality, 
...
place_pop_by_race <- place_pop_by_race %>% 
  select(year, state, place, total_people, total_nonhispanic = total_nonhisp, asian_other, 
