...
county_pop_by_race <- county_pop_by_race %>% 
  select(year, state, county, asian_other, black_nonhispanic, hispanic = total_hispanic, white_nonhispanic,
         total_nonhispanic_quality = total_nonhisp_quality, asian_other_quality, 
...
place_pop_by_race <- place_pop_by_race %>% 
  select(year, state, place, asian_other, black_nonhispanic, hispanic = total_hispanic, white_nonhispanic,
         total_nonhispanic_quality = total_nonhisp_quality, asian_other_quality, 
         black_nonhispanic_quality, total_hispanic_quality, white_nonhispanic_quality) %>%
  mutate(year = update_year)
```
