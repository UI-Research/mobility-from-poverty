...
Keep the most recent year of population data (not 2022, but 2021).
...
county_pop_by_race <- county_pop_by_race %>% 
  select(year, state, county, total_people, total_nonhisp, 
         asian_other, black_nonhispanic, hispanic = total_hispanic, white_nonhispanic,
...
county_pop_by_race <- county_pop_by_race %>% 
  ...
  rename(share_desc_rep_total_population = share_desc_rep_total_people, 
         share_desc_rep_total_population_quality = share_desc_rep_total_people_quality)
```
...
place_pop_by_race <- place_pop_by_race %>% 
  select(year, state, place, total_people, total_nonhisp, asian_other, 
         black_nonhispanic, hispanic = total_hispanic, white_nonhispanic,
         total_people_quality, total_nonhisp_quality, asian_other_quality, 
         black_nonhispanic_quality, total_hispanic_quality, white_nonhispanic_quality) %>%
  mutate(year = 2021)
```
...
## Export
```{r}
write_csv(county_pop_by_race, here::here("05_local-governance", "descriptive-representation", "data", "final", "descriptive_rep_denominator_county_2022.csv"))

write_csv(place_pop_by_race, here::here("05_local-governance", "descriptive-representation", "data", "final", "descriptive_rep_denominator_city_2022.csv"))
```
