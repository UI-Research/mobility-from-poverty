...
# XX would it be worth it to see how districts relate to counties?
# Also, for the 2018 data, Aaron said "Alaska is reported as Districts instead of counties. We drop these." but I think the more accurate wording is that we replace the FIPS codes for all Alaska districts with "02000" because we are not actually dropping the observations (in 2018 or 2020).
```
