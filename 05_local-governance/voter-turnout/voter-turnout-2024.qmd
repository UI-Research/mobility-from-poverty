...
The voting "Mode" category differs by state in the 2024 data. This requires further cleaning to get the totals as includnig the entire vote category now results in duplicates. 

We only want mode as "TOTAL VOTES" or NA and we need to remove total vote from the candidate category.
...
The census vote counts show more variability and offen do not direcitonally aggree with the Wikipedia votes.
```{r}
...
all_counties %>%
  select(-population) %>%
  bind_rows(
  read_csv(here::here("05_local-governance", "voter-turnout", "data", "final", "voter-turnout-2016.csv")),
  read_csv(here::here("05_local-governance", "voter-turnout", "data", "final", "voter-turnout-2020.csv"))
  ) %>% 
  write_csv(here::here("05_local-governance",
                       "voter-turnout",
                       "data",
...
```{r}
turnout2020 <- read_csv(here::here("05_local-governance",
                                   "voter-turnout",
                                    "data",
                                    "final",
