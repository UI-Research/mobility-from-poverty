...
params: 
  geography: "county"
  county_years: !expr c(2014:2019)
  place_years: !expr c(2014:2019)
format: 
  html:
    toc: true
...
fmr_income_limits = map2_dfr(
    county_years, urls_fmr_income_limits[1:6], 
...
If the unweighted sum of interpolated households (reflected in `afact`) is under 30, 
we suppress that cell because it is likely to be highly unreliable.
