...
Download 2021 mobility metrics at the place level: https://datacatalog.urban.org/dataset/boosting-upward-mobility-metrics-inform-local-action-10 and save in the 02_housing/data/temp folder in the UMF repository as "mobility_metrics_place.csv"

```{r}

metrics_2021 <- read_csv(here::here("02_housing", "data", "temp", "mobility_metrics_place.csv")) %>% 
  filter(year == 2021) %>% 
