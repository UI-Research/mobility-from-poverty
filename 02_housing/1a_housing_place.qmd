...
NOTE: There is an API to do this that should be used in future updates of the data but we didn't have the capacity to update in 2023
...
destfile <- here::here("02_housing/data/temp/FMR_Income_Levels_2022.xlsx")

# Import the data file & save locally
download.file(url, destfile, mode="wb")

# Import the data file as a dataframe
FMR_Income_Levels_2022 <- read_excel(here::here("02_housing/data/temp/FMR_Income_Levels_2022.xlsx"))
```
...
# Specify destination where file should be saved (the .gitignore folder for your local branch)
destfile_FMR <- here::here("02_housing/data/temp/FMR_pop_2022.xlsx")

# Import the data file & save locally
download.file(url_FMR, destfile_FMR, mode="wb")

# Import the data file as a dataframe
FMR_pop_2022 <- read_excel(here::here("02_housing/data/temp/FMR_pop_2022.xlsx"))
```
...
write_csv(households_2022, here::here("02_housing/data/temp/households_2022.csv"))
...
write_csv(vacant_2022_new, here::here("02_housing/data/temp/vacant_2022.csv"))
...
write_csv(vacant_summed_2022, here::here("02_housing/data/temp/vacant_summed_2022.csv"))
