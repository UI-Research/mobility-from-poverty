...
place_puma <- read_csv(here::here("02_housing/data/temp/place_puma.csv")) %>% 
  rename("state" = "statefip")

# Merge the PUMA flag in & create the final data quality metric based on both size and puma flags
housing <- left_join(housing, place_puma, by=c("state","place"))
...
write_csv(housing_2022_overall, here::here("02_housing/data/housing_2022_city.csv"))
```
...
# export our file as a .csv
write_csv(housing_2022_subgroup_final, here::here("02_housing/data/housing_2022_subgroups_city.csv"))
```
