...
Also create variable for total population at 80% AMI, 50% AMI, and 30% AMI for renter and owner subgroups, this is just the population of renters or owners at each income level
...
NLIHC has an Out of Reach tool that is a good benchmark for comparing results to: https://nlihc.org/oor
it's not a 1:1 equivalent measure, but gives a sense of the cost of renting in each state and by zip code
