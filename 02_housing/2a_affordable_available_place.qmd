...
households_2022 <- read_csv(here::here("02_housing/data/temp/households_2022.csv"))
...
vacant_summed_2022 <- read_csv(here::here("02_housing/data/temp/vacant_summed_2022.csv"))
```
...
affordable_2022_subgroup <- read_csv(here::here("02_housing/data/housing_2022_subgroups_city.csv")) %>% 
  select(state, place, matches("quality"))
...
write_csv(available_2022_subgroup, here::here("02_housing/data/available_2022_city.csv"))  
```
...
affordable_2022_overall <- read_csv(here::here("02_housing/data/housing_2022_city.csv"))
...
available_2022_overall <- available_2022_subgroup %>% 
  ...
  mutate(across(matches("share_.*quality$"),
         ...
         across(matches("share_affordable_available.*ami$"), \(x) if_else(is.na(get(cur_column() %>% paste0("_quality"))), NA, x))) %>% 
    # arrange columns and drop unneeded ones
  select(year, state, place, matches("available_30"),  matches("available_50"), matches("available_80"))


# export our file as a .csv
write_csv(available_2022_overall, here::here("02_housing/data/available_2022_subgroups_city.csv")) 
```
