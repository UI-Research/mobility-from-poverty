...
write_csv(available_2022_subgroup, here::here("02_housing/data/available_2022_subgroups_city.csv"))  
```
...
# export our file as a .csv
write_csv(available_2022_overall, here::here("02_housing/data/available_2022_city.csv")) 
```
