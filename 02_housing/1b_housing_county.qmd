...
acs2022 <- read_csv(here::here("02_housing/data/temp/2022microdata_county.csv"))
...
write_csv(households_2022, here::here("02_housing/data/temp/households_2022_county.csv"))
...
write_csv(vacant_summed_2022, here::here("02_housing/data/temp/vacant_summed_2022_county.csv"))
```
...
county_puma <- read_csv(here::here("02_housing/data/temp/county_puma.csv"))
...
write_csv(housing_2022_overall, here::here("02_housing/data/housing_2022_county.csv"))
```
...
# export our file as a .csv
write_csv(housing_2022_subgroup_final, here::here("02_housing/data/housing_2022_subgroups_county.csv"))  
```
...
Read in 2021 data. Download 2021 mobility metrics at the place level: https://datacatalog.urban.org/dataset/boosting-upward-mobility-metrics-inform-local-action-10

Save in Downloads folder as "mobility_metrics_county.csv"
