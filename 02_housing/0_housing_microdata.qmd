...
\(1\) Download microdata from IPUMS API for 2022 and 2021
...
# extract data for 2022 and 2021
map(years, extract_vacant_ipums)
```
...
map(years, puma_place_crosswalk)

# NOTE TO JP: 2021 is missing data for place fips 72122 in Georgia
...
# loop over 2021 and 2022
map(years, puma_county_crosswalk)

# check number of unique places in data
stopifnot(
  # 2022 data
  read_csv(here::here("02_housing","data","temp", "puma_county_2022.csv")) %>% 
    distinct(statefip, county) %>% nrow() == 3143,
  
  # 2021 data
  read_csv(here::here("02_housing","data","temp", "puma_county_2021.csv")) %>% 
    distinct(statefip, county) %>% nrow() == 3143
)
