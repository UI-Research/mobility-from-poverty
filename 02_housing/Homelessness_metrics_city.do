...
*keep variables we need 
	...
	*2022* keep year leaid *homeless* *black* *hispanic* *white* *other* 
	tostring leaid, replace
...
*2022 * collapse (sum) *homeless* *black* *hispanic* *other* *white* enrollment , by(year state city_name)
...
*new as of 4/13/23 if enrollment is less than 30, it's set to NA
...
*2022 order year state city_name *homeless* black* hispanic* other* white*
