...
vacant_summed_2022 <- read_csv(here::here("02_housing/data/temp/vacant_summed_2022_county.csv"))
```
...
available_2022_final <- available_2022 %>% 
  ...
  mutate(
    ...
    share_affordable_available_30_ami_renter = (at_rent30_renter+Affordable30AMI_renter_vacant)/Below30AMI, 
    share_affordable_available_30_ami_owner = (at_rent30_owner+Affordable30AMI_owner_vacant)/Below30AMI, 
    ...
    share_affordable_available_50_ami_renter = (at_rent50_renter+Affordable50AMI_renter_vacant)/Below50AMI, 
    share_affordable_available_50_ami_owner = (at_rent50_owner+Affordable50AMI_owner_vacant)/Below50AMI, 
    ...
    share_affordable_available_80_ami_renter = (at_rent80_renter+Affordable80AMI_renter_vacant)/Below80AMI, 
    share_affordable_available_80_ami_owner = (at_rent80_owner+Affordable80AMI_owner_vacant)/Below80AMI
  )
```
...
```{r}
affordable_2022_subgroup <- read_csv(here::here("02_housing/data/housing_2022_subgroups_county.csv")) %>% 
  select(state, county, matches("quality"))
...
write_csv(available_2022_subgroup, here::here("02_housing/data/available_2022_subgroups_county.csv"))  
```
...
affordable_2022_overall <- read_csv(here::here("02_housing/data/housing_2022_county.csv"))

# keep what we need
available_2022_overall <- available_2022_subgroup %>% 
  filter(subgroup == "All") %>% 
  select(year, state, county, share_affordable_available_80_ami, share_affordable_available_50_ami, share_affordable_available_30_ami) %>% 
  ...
  mutate(across(matches("share_.*quality$"),
    ...
    # arrange columns and drop unneeded ones
  select(year, state, county, matches("available_30"),  matches("available_50"), matches("available_80"))


# export our file as a .csv
write_csv(available_2022_overall, here::here("02_housing/data/available_2022_county.csv"))  
```
