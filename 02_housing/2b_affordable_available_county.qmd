...
households_2022 <- read_csv(here::here("02_housing/data/temp/households_county.csv")) %>% 
  filter(year == 2022)
...
vacant_summed_2022 <- read_csv(here::here("02_housing/data/temp/vacant_summed_county.csv"))%>% 
  filter(year == 2022)
```
