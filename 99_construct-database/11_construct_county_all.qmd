...
read_csv(here("11_housing-affordability/data/final/housing_county_2014_2015_2016_2017_2018_2019_2021_2022_2023_2024.csv")) |>
  select(-subgroup_type, -subgroup) |>
  write_csv(here("data", "temp", "housing_county.csv"))

# read combined voter turnout file
read_csv(here("21_political-participation", "data", "final", "voter-turnout-2016-2024.csv")) |>
  write_csv(
    here("data", "temp", "voter-turnout.csv")
  )

# read combined homelessness file
read_csv(here("12_housing-stability/data/final/homelessness_2014-2022_county.csv")) |>
...
read_csv(here("23_safety-from-crime/data/final/rates_crime_county_all.csv")) %>% 
...
read_csv(here("24_just-policing/data/final/rate_arrests_county_all.csv")) %>% 
  mutate(combine_fip = paste0(state, county),
...
filepaths <- c(
  ...
  here("03_opportunities-for-income/final/metrics_income_county_all_longitudinal.csv"),
  here("05_wealth-building-opportunities/final/households_house_value_race_ethnicity_all_county.csv"),
  here("04_financial-security/final/metrics_overall_debt_coll_all_county.csv"),
  ...
  # 04 health
  here("17_access-to-health-services/final/ratio_pop_pcp_metric_all_county.csv"),
  here("18_neonatal-health/data/final/rate_low_birth_weight_metric_all_county.csv"),
  here("20_safety-from-trauma/data/final/rate_injury_deaths_metric_all_county.csv"),
  
  # 05 local-governance
  here("22_descriptive-representation/data/final/descriptive_rep_denominator_county_all.csv"),
  here("data", "temp", "voter-turnout.csv"),

  # 06 neighborhoods
  here("14_racial-diversity/final/race-ethnicity-exposure-county.csv"),
  here("13_economic-inclusion/final/poverty-exposure_county.csv"),
  here("15_social-capital/final/social_associations_all_county.csv"),
  here("15_social-capital/final/economic_connectedness_version2025_county_2022.csv"),
  here("16_transportation-access/final/transportation_all_county.csv"),
  here("19_environmental-quality/data/final/environment_county_longitudinal.csv"),
  ...
  # 08 education
  here("06_access-to-preschool/data/final/metrics_preschool_county_all_longitudinal_all.csv"),
  here("09_preparation-for-college/data/built/SEDA_all_county_2014-2018.csv"),
  here("08_school-economic-diversity/data/final/meps_county_2014-2022.csv"),
  here("09_preparation-for-college/data/final/metrics_college_county_all_longitudinal.csv"),
  here("10_digital-access/data/final/digital_access_county_all_longitudinal.csv"),
  
  # 09 employment
  here("01_employment-opportunities/data/final/metrics_employment_county_all_longitudinal.csv"),
  here("02_jobs-paying-living-wages/data/final/living_wage_county_all_longitudinal.csv")
)
...
```{r}
db |>
  write_csv(here("data", "11_mobility-metrics_county_longitudinal.csv"))
