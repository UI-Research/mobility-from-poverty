...
read_csv(here("14_racial-diversity/race-ethnicity-exposure-city.csv")) |>
  select(-state_place) |>
  write_csv(here("data", "temp", "race-ethnicity-exposure-city.csv"))


bind_rows(
  read_csv(here("21_political-participation/data/final/voter-turnout-city-2016.csv")),
  read_csv(here("21_political-participation/data/final/voter-turnout-city-2020.csv")) |>
    rename(
...
read_csv(here("12_housing-stability/data/final/homelessness_2014-2022_city.csv")) |>
  write_csv(
...
read_csv(here("23_safety-from-crime/data/final/rates_crime_place_all.csv")) %>% 
...
read_csv(here("24_just-policing/data/final/rate_arrests_place_all.csv")) %>% 
  mutate(combine_fip = paste0(state, place),
...
read_csv(here("11_housing-affordability/data/final/housing_place_2014_2015_2016_2017_2018_2019_2021_2022_2023_2024.csv")) %>% 
  mutate(combine_fip = paste0(state, place),
...
filepaths <- c(
  ...
  here("03_opportunities-for-income/final/metrics_income_place_all_longitudinal.csv"),
  here("05_wealth-building-opportunities/final/households_house_value_race_ethnicity_all_city.csv"),
  here("04_financial-security/final/metrics_overall_debt_coll_all_city.csv"),
  #
  # 02 housing
  here("data", "temp", "homelessness_city_all.csv"),
  here("data", "temp", "housing_place_all.csv"),
  ...
  #
  # 05 local-governance
  here("22_descriptive-representation/data/final/descriptive_rep_denominator_city_all.csv"),
  here("data", "temp", "voter-turnout-city.csv"),
  #
  # 06 neighborhoods
  here("data", "temp", "race-ethnicity-exposure-city.csv"),
  here("13_economic-inclusion/final/poverty-exposure_city.csv"),
  here("15_social-capital/final/social_associations_all_city.csv"),
  here("15_social-capital/final/economic_connectedness_version2025_place_2022.csv"),
  here("19_environmental-quality/data/final/environment_place_longitudinal.csv"),
  here("16_transportation-access/final/transportation_all_city.csv"),
  #
  # 07 safety
  here("data", "temp", "rates_crime_place_all.csv"),
  here("data", "temp", "rates_arrest_place_all.csv"),
  #
  # 08 education
  here("06_access-to-preschool/data/final/metrics_preschool_place_all_longitudinal_all.csv"),
  here("09_preparation-for-college/data/built/SEDA_all_city_2014-2018.csv"),
  here("08_school-economic-diversity/data/final/meps_place_2014-2022.csv"),
  here("09_preparation-for-college/data/final/metrics_college_place_all_longitudinal.csv"),
  here("10_digital-access/data/final/digital_access_place_all_longitudinal.csv"),
  #
  # 09 employment
  here("01_employment-opportunities/data/final/metrics_employment_place_all_longitudinal.csv")
...
```{r}
db |>
  write_csv(here("data", "61_mobility-metrics_place_longitudinal.csv"))
```
