...
read_csv(here("10_digital-access/data/final/digital_access_place_race_ethnicity_longitudinal.csv"))|>
...
read_csv(here("12_housing-stability/data/final/homelessness_2019-2022_subgroups_city.csv")) %>% 
...
read_csv(here("24_just-policing/data/final/rate_arrests_place_all_subgroup.csv")) %>% 
  mutate(combine_fip = paste0(state, place),
...
filepaths <- c(
  ...
  here("03_opportunities-for-income/final/metrics_income_place_race-ethnicity_longitudinal.csv"),
  ...
  # 06 neighborhoods
  here("13_economic-inclusion", "final", "poverty-exposure_race-ethnicity_city.csv"),

  # 07 safety
  here("data", "temp", "rates_arrest_place_race.csv"),

  # 08 education
  here("06_access-to-preschool/data/final/metrics_preschool_place_race-ethnicity_longitudinal.csv"),
  here("data", "temp", "SEDA_all_subgroups_city.csv"),
  here("09_preparation-for-college/data/final/metrics_college_place_race-ethnicity_longitudinal.csv"),
  here("data", "temp", "digital_access_race_city.csv"),

  # 09 employment
  here("01_employment-opportunities/data/final/metrics_employment_place_race-ethnicity_longitudinal.csv")
)
```
...
```{r}
db_race_eth |>
  write_csv(here("data", "62_mobility-metrics_place_race-ethnicity_longitudinal.csv"))
```
