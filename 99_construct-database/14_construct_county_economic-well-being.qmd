...
```{r}
read_csv(here("19_environmental-quality/data/final/environment_county_poverty_longitudinal.csv")) |>
...
read_csv(here("07_effective-public-education-hold/data/built/SEDA_all_subgroups_county_2014-2018.csv")) |>
...
filepaths <- c(
  ...
  here("10_digital-access/data/final/digital_access_county_income_longitudinal.csv"),
  here("06_access-to-preschool/data/final/metrics_preschool_county_income_longitudinal.csv")
...
db_income |>
  write_csv(here("data", "14_mobility-metrics_county_income_longitudinal.csv"))
