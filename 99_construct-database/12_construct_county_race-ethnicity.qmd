...
read_csv(here("20_safety-from-trauma/data/final/rate_injury_deaths_metric_subgroup_county.csv"))|>
...
read_csv(here("10_digital-access/data/final/digital_access_county_race_ethnicity_longitudinal.csv"))|>
...
read_csv(here("09_preparation-for-college/data/built/SEDA_all_subgroups_county_2014-2018.csv")) |>
  filter(subgroup_type %in% c("all", "race-ethnicity")) |>
...
here("03_opportunities-for-income/final/metrics_income_county_race-ethnicity_longitudinal.csv"),

# 02 housing
here("12_housing-stability/data/final/homelessness_2019-2022_subgroups_county.csv"),
...
# 06 neighborhoods
here("13_economic-inclusion/final/poverty-exposure_race-ethnicity_county.csv"),

# 07 safety
here("data", "temp", "rate_arrests_county_race-ethnicity_subgroup.csv"),

# 08 education
here("06_access-to-preschool/data/final/metrics_preschool_county_race-ethnicity_longitudinal.csv"),
here("data", "temp", "SEDA_race-ethnicity_subgroup_county_2014-2018.csv"),
here("09_preparation-for-college/data/final/metrics_college_county_race-ethnicity_longitudinal.csv"),
here("data", "temp", "digital_access_race-ethncity.csv"),

# 09 employment
here("01_employment-opportunities/data/final/metrics_employment_county_race-ethnicity_longitudinal.csv")
)
...
db_race_eth |>
  write_csv(here("data", "12_mobility-metrics_county_race-ethnicity_longitudinal.csv"))
