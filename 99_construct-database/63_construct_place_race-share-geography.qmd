...
read_csv(here("19_environmental-quality/data/final/environment_place_race-ethnicity_longitudinal.csv")) |>
...
filepaths <- c(
  ...
  here("04_financial-security/final/metrics_overall_debt_coll_race_ethnicity_city.csv"),

  # 06 neighborhoods
  here("data", "temp", "environment_place_subroup_race_share.csv"),

  here("16_transportation-access/final/transportation_subgroup_city.csv")
)
...
db_race_share |>
  write_csv(here("data", "63_mobility-metrics_place_race-share_longitudinal.csv"))
