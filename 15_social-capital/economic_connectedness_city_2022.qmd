...
Author: This code was initially written by Tina Chelidze (see `15_social-capital/economic_connectedness_city_code_2022.R`) and updated by Ridhi Purohit in January, 2025. 
...
destfile <- here::here("15_social-capital", "temp","social_capital_zip.csv")
...
# read data
ec_zip_raw <- read.csv(here::here("15_social-capital", "temp", "social_capital_zip.csv"))
...
evaluate_final_data(
    exp_form_path = 
      here::here("99a_final-evaluation", "evaluation_form_social_cap2_overall_place.csv"),
...
After successfully evaluating the final data, store the final data file `economic_connectedness_version2025_place_2022.csv` in folder `15_social-capital/final/`.
