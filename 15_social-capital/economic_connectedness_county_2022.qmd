...
Author: This code was initially written by Tina Chelidze (see `15_social-capital/economic_connectedness_county_code_2022.R`) and updated by Ridhi Purohit in January, 2025.
...
destfile <- here::here("15_social-capital", "temp","social_capital_county.csv")
...
# read data
ec_raw <- read.csv(here::here("15_social-capital", "temp", "social_capital_county.csv"))
...
evaluate_final_data(
    exp_form_path = 
      here::here("99a_final-evaluation", "evaluation_form_social_cap2_overall_county.csv"),
...
After successfully evaluating the final data, store the final data file `economic_connectedness_version2025_county_2022.csv` in folder `15_social-capital/final/`.
