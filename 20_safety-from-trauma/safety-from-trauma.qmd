...
```{r evaluate-all}
evaluate_final_data(
  exp_form_path = "99a_final-evaluation/evaluation_form_injury_death_overall_county.csv",
  data = final_all,
  geography = "county",
  subgroups = FALSE, 
...
```{r evaluate-subgroup}
evaluate_final_data(
  exp_form_path = "99a_final-evaluation/evaluation_form_injury_death_subgroup_county.csv",
  data = final_subgroup,
  geography = "county",
  subgroups = TRUE, 
  confidence_intervals = TRUE
