...
-   Move the `.txt` file from your Downloads folder to the `mobility-from-poverty\safety-from-trauma\data\bridged-race` directory.
...
## 3.3 Single Race (2021-2024), Subgroups
