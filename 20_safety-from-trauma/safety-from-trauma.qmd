...
All data used in this file are available on Box [here](https://urbanorg.app.box.com/folder/309936150141). Data stored on Box are only available to Urban Institute researchers.
...
This section explains the manual download process to create data extracts for these data from CDC WONDER. All data used in this file are available on Box [here](https://urbanorg.app.box.com/folder/309936150141). Data stored on Box are only available to Urban Institute researchers.
