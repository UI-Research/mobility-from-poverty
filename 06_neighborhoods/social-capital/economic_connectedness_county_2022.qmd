...
We will calculate the 95% confidence interval for the metric `share_economic_connectedness` using the `qnorm` function and standard error variable `ec_se_county_updated`. 
