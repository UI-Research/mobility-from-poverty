...
Create the merged file where the SA numerator (`count_orgs`) is averaged per 
Place, weighted by the % area of the ZCTA in that Place (`avg_orgs_per_place_weighted_by_area`) 
...
We create a ratio value to see how many of the ZIPs we aggregated fell fully 
into a Census Place boundary
