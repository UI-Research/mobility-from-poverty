...
gg_miss_var(merged_associations |> filter(year != 2014)) +
...
evaluate_final_data(here("06_neighborhoods/social-capital/data/final_data_evaluation_form.csv"), merged_associations, "county", subgroups = FALSE, confidence_intervals = FALSE)
```
