...
transportation_county |>
  ...
  select(year, state, county, households, score_transit_trips, score_transit_trips_change) |>
  print(n = Inf)
...
transportation_county <- transportation_county |>
  mutate(
    score_transit_trips_quality = 
      if_else(is.na(score_transit_trips), NA, score_transit_trips_quality), 
...
final_data <- transportation_county |>
  select(year, state, county, score_transit_trips, score_transit_trips_quality, share_transportation_cost, share_transportation_cost_quality) |>
