...
transit_cost_tracts_2029$GEOID <- paste0(transit_cost_tracts_2020$state, transit_cost_tracts_2020$county, transit_cost_tracts_2020$tract)
...
```{r}
transit_cost_tracts_2020 <- transit_cost_tracts_2020 %>%
...
73056 obs to 124139 (142337 for 2020) obs - makes sense as tracts and places don't match up perfectly, so there's multiplicity.
