...
med_hh_income_cv <- med_hh_income_cv |>
  ...
  select(
    ...
    index_transportation_cost_quality_county = index_transportation_cost_quality
  )
...
transportation_county <- transportation_county |>
  mutate(
    ...
    index_transportation_cost_quality = 
      pmax(index_transportation_cost_quality, index_transportation_cost_quality_county)
  )
...
stopifnot(
  transportation_county |>
    filter(
      (is.na(score_transit_trips) | is.na(index_transportation_cost)) &
        (!is.na(score_transit_trips_quality) | !is.na(index_transportation_cost_quality))
    ) |>
    nrow() == 0
)
...
final_data <- transportation_county |>
  select(year, state, county, subgroup_type, subgroup, score_transit_trips, score_transit_trips_quality, index_transportation_cost, index_transportation_cost_quality) 
