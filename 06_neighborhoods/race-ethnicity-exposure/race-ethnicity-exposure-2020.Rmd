...
tracts <- tracts %>%
  select(-other_nh_moe) %>%
  rename(other_nh_moe = other_nh_moe_reduced)
...
```{r}
# XX this doesn't look true for 2021
tracts_moe %>%
...
county_data %>%
  ...
  write_csv(here::here("06_neighborhoods", "race-ethnicity-exposure", "race-ethnicity-exposure-2020.csv"))
