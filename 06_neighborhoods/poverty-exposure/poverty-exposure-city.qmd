...
final_county_data <- read_csv(here::here("06_neighborhoods", "poverty-exposure", "final", "poverty-exposure_city.csv"), show_col_types = FALSE)

evaluate_final_data(
  exp_form_path = "10a_final-evaluation/evaluation_form_exposure_poverty_overall_city.csv",
  data = final_county_data, geography = "place",
