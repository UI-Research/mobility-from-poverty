...
evaluate_final_data(data = metrics_education_all, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_preschool_overall_county.csv"), geography = "county", subgroups = FALSE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_education_race, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_preschool_race_eth_county.csv"), geography = "county", subgroups = TRUE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_education_income, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_preschool_income_county.csv"), geography = "county", subgroups = TRUE, confidence_intervals = TRUE)
...
write_csv(metrics_education_all, 
          here::here("06_access-to-preschool", "data", "final", "metrics_preschool_county_all_longitudinal_all.csv")
          )
