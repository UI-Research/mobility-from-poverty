...
Select which years of new data you want to run for the preschool place and county metric.
...
reports <-
  tibble(
    input = here::here("06_access-to-preschool", "preschool_county.qmd"),
    output_file = glue::glue("calculate-{params$metric_name}-county-{years}.html"),
...
reports <-
  tibble(
    input = here::here("06_access-to-preschool", "preschool_place.qmd"),
