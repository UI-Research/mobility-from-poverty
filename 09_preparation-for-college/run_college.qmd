...
reports <-
  tibble(
    input = here::here("09_preparation-for-college", "college_metrics_county.qmd"),
...
reports <-
  tibble(
    input = here::here("09_preparation-for-college", "college_metrics_place.qmd"),
