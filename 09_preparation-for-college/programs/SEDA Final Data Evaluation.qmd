...
This file tests the final data for the SEDA metric on students English Language Arts scores (ELA). There are four final files to be tested:
 ...
 - `09_preparation-for-college/data/built/SEDA_all_city_2014-2018.csv`
 - `09_preparation-for-college/data/built/SEDA_all_county_2014-2018.csv`
 - `09_preparation-for-college/data/built/SEDA_all_subgroups_city_2014-2018.csv`
 - `09_preparation-for-college/data/built/SEDA_all_subgroups_county_2014-2018.csv`

Read these final files in.

```{r}
final_data_city <- read_csv(here("09_preparation-for-college/data/built/SEDA_all_city_2014-2018.csv"), show_col_types = FALSE)

final_data_county <- read_csv(here("09_preparation-for-college/data/built/SEDA_all_county_2014-2018.csv"), show_col_types = FALSE)

final_data_city_sub <- read_csv(here("09_preparation-for-college/data/built/SEDA_all_subgroups_city_2014-2018.csv"), show_col_types = FALSE)

final_data_county_sub <- read_csv(here("09_preparation-for-college/data/built/SEDA_all_subgroups_county_2014-2018.csv"), show_col_types = FALSE)
```
...
City level data.
```{r}
evaluate_final_data(exp_form_path = "99a_final-evaluation/evaluation_form_ela_overall_place.csv",
...
County level data.
```{r}
evaluate_final_data(exp_form_path = "99a_final-evaluation/evaluation_form_ela_overall_county.csv",
...
```{r}
evaluate_final_data(exp_form_path = "99a_final-evaluation/evaluation_form_ela_race_ethnicity_place.csv",
                data = final_data_city_race,  geography = "place",
                subgroups = TRUE, confidence_intervals = TRUE)

evaluate_final_data(exp_form_path = "99a_final-evaluation/evaluation_form_ela_income_place.csv",
                data = final_data_city_income,  geography = "place",
                subgroups = TRUE, confidence_intervals = TRUE)

evaluate_final_data(exp_form_path = "99a_final-evaluation/evaluation_form_ela_gender_place.csv",
...
County level data.
```{r}
evaluate_final_data(exp_form_path = "99a_final-evaluation/evaluation_form_ela_race_ethnicity_county.csv",
                data = final_data_county_race,  geography = "county",
                subgroups = TRUE, confidence_intervals = TRUE)

evaluate_final_data(exp_form_path = "99a_final-evaluation/evaluation_form_ela_income_county.csv",
                data = final_data_county_income,  geography = "county",
                subgroups = TRUE, confidence_intervals = TRUE)

evaluate_final_data(exp_form_path = "99a_final-evaluation/evaluation_form_ela_gender_county.csv",
