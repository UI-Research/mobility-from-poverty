...
urban_antijoin <- tidylog::anti_join(
  ...
  filter(
    ...
    str_sub(GEOID, 1, 2) == connecticut_fips & year %in% c(2022, 2023)
    ) 
...
Only 8 observations have a data quality value of 3 (Chugach Census Area, AK and Copper River Census Area, AK in each year 2021-2023). 2,734 observations are missing data quality for the total death rate.
```{r check-quality3}
joined_data |>
  group_by(subgroup) |>
