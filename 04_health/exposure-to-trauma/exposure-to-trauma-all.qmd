...
# Prove all records in urban_counties are from Chugach Census Area, Copper River Census Area, or Connecticut
urban_antijoin <- tidylog::anti_join(
  ...
  filter(
    ...
    str_sub(GEOID, 1, 2) == connecticut_fips
    ) 
...
# This code returns an error but looking at the data manually, I can see that it is true
death_rates_wide_anti_join |> 
