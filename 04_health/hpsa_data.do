...
merge 1:m state county using "${gitfolder}\04_health\data\intermediate\HPSAdesignated_PC.dta"
...
replace hpsascore = 0 if hpsascore == . /* no hpsa designation in N=2,042 counties*/
...
drop designationtype hpsastatus hpsaid 

order year state county hpsascore hpsascore_quality
