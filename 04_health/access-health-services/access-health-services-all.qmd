...
#'   Default: `here::here("04_health","access-health-services","data")`.
#'
...
#' # haven::read_sas(here::here("04_health","access-health-services","data",
#' #                             "AHRF 2023-2024 SAS","ahrf2024_feb2025.sas7bdat"),
#' #                 catalog_encoding = "Latin1")
#' }
ahrf_fetch <- function(
  url,
  data_dir = here::here("04_health", "access-health-services", "data")
) {
...
ahrf22 <- haven::read_sas(
  here::here("04_health","access-health-services","data","ahrf2022.sas7bdat"),
  catalog_encoding = "Latin1"
)
...
ahrf23 <- haven::read_sas(
  here::here(
    "04_health","access-health-services","data",
...
if (
  !file.exists(here::here("04_health", "access-health-services", "data", "chr2023.xlsx"))
){
  download.file(
  ...
  destfile = here::here("04_health", "access-health-services", "data", "chr2023.xlsx"),
  mode = "wb"
)
}
...
if (
  !file.exists(here::here("04_health", "access-health-services", "data", "chr_pop.csv"))
){
  
  download.file(
    url = "https://www2.census.gov/programs-surveys/popest/datasets/2010-2020/counties/totals/co-est2020.csv",
    destfile = here::here("04_health", "access-health-services", "data", "chr_pop.csv"),
    mode = "wb"
  )
