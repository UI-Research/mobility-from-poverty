...
```{r load-2023-2024-file}
# URL of the 2023-2024 AHRF zip file
zip_url_24 <- "https://data.hrsa.gov/DataDownload/AHRF/AHRF%202023-2024%20SAS.zip"

# Destination file path where we want to save the zip file
zip_dest_24 <- here::here(
  "04_health",
  "access-health-services",
  "data",
  "AHRF_SAS_2023-2024.zip"
)


# If the file has not already been downloaded, download/unzip/read it in
if (
  ...
  download.file(zip_url_24, zip_dest_24, mode = "wb")

  # Unzip the file
  unzip(
    zip_dest_24,
    exdir = here::here("04_health", "access-health-services", "data")
  )
...
ahrf24 <- haven::read_sas(here::here(
  "04_health",
  "access-health-services",
  "data",
  "AHRF 2023-2024 SAS",
  "ahrf2024_feb2025.sas7bdat"
), catalog_encoding =  "UTF-8")

# Clean up environment
rm(zip_url_24, zip_dest_24)
...
# If the file has not already been downloaded, download/unzip/read it in
if (
  !file.exists(here::here("04_health", "access-health-services", "data",
                          "AHRF_SAS_2022-2023"))
  ){
...
ahrf23 <- haven::read_sas(here::here("04_health", "access-health-services", "data",
                                "AHRF_SAS_2022-2023", "ahrf2023.sas7bdat"), catalog_encoding =  "UTF-8")
...
ahrf22 <- haven::read_sas(here::here("04_health", "access-health-services", "data", "ahrf2022.sas7bdat"), catalog_encoding =  "UTF-8")
...
all_counties <- read_csv(here::here("geographic-crosswalks", "data", "county-populations.csv"), locale = locale(encoding = "UTF-8")) |>
...
```{r table, echo = FALSE}
# Note this table is commented out because I get this error which I haven't been able to debug:
