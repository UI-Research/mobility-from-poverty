...
ahrf2022 <- ahrf2022 %>%
  select(
    ...
    f1467920, # DOs, primary care, patient care 2020
    f1212920, # total active MDs, non-fed and fed, 2020
    f0482020, # total MDs, male, 2020
    f0482120, # total MDs, female, 2020
    f0490020, # MDs inactive, male, 2020
    f0490120, # MDs inactive, female, 2020
  ) %>%
  filter(
...
ahrf2022 <- ahrf2022 %>%
  mutate(
    pc_phys_ratio = case_when(
      pc_physicians > 0 ~ population/pc_physicians,
      pc_physicians == 0 ~ 0),
