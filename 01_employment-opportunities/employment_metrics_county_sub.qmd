...
if(isTRUE(bucket_exists(bucket = my_bucket))){
  ...
  write_csv(paste0(here::here("01_employment-opportunities", "data", "intermediate"), 
                  "/", "metrics_employment_sub_county_", params$year, ".csv"))
  }
```
...
evaluate_final_data(data = metrics_employment_race, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_employment_race_eth_county.csv"), geography = "county", subgroups = TRUE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_employment_gender, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_employment_gender_county.csv"), geography = "county", subgroups = TRUE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_employment_disability, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_employment_disability_county.csv"), geography = "county", subgroups = TRUE, confidence_intervals = TRUE)
...
write_csv(metrics_employment_race, here::here("01_employment-opportunities", "data", "final", "metrics_employment_county_race-ethnicity_longitudinal.csv"))


write_csv(metrics_employment_gender, here::here("01_employment-opportunities", "data", "final", "metrics_employment_county_gender_longitudinal.csv"))


write_csv(metrics_employment_disability, here::here("01_employment-opportunities", "data", "final", "metrics_employment_county_disability_longitudinal.csv"))
```
