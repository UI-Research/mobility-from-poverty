...
counties_new <- read_csv(here("01_employment-opportunities", "data", "final", "metrics_employment_county_all_longitudinal.csv")) %>% 
...
counties_new_race <- read_csv(here("01_employment-opportunities", "data", "final", "metrics_employment_county_race-ethnicity_longitudinal.csv")) %>% 
