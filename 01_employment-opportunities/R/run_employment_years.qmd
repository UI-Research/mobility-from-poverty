...
reports <-
  tibble(
    input = here::here("01_employment-opportunities", "employment_metrics_county_all.qmd"),
...
reports <-
  tibble(
    input = here::here("01_employment-opportunities", "employment_metrics_place_all.qmd"),
