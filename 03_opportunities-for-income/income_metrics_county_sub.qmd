...
Median income for select counties over time by race and ethnicity
...
80th percentile income for select counties over time by race and ethnicity
...
Median income for select counties over time by gender
...
evaluate_final_data(data = metrics_income_gender, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_income_gender_county.csv"), geography = "county", subgroups = TRUE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_income_race, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_income_race_eth_county.csv"), geography = "county", subgroups = TRUE, confidence_intervals = TRUE)
```
...
write_csv(metrics_income_gender, here::here("03_opportunities-for-income", "final", "metrics_income_county_gender_longitudinal.csv"))

metrics_income_race %>% 
  head(10)

write_csv(metrics_income_race, here::here("03_opportunities-for-income", "final", "metrics_income_county_race-ethnicity_longitudinal.csv"))
```
