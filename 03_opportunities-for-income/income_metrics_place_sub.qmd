...
evaluate_final_data(data = metrics_income_gender, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_income_gender_place.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
...
evaluate_final_data(data = metrics_income_race, exp_form_path = here::here("99a_final-evaluation", "evaluation_form_income_race_eth_place.csv"), geography = "place", subgroups = TRUE, confidence_intervals = TRUE)
```
