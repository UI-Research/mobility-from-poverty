...
years = c("2014", "2015", "2016", "2017", "2018", "2019", "2021", "2022", "2023", "2024")

years_place = c("2016", "2017", "2018", "2019", "2021", "2022", "2023", "2024")
...
reports <-
  tibble(
    input = here::here("03_opportunities-for-income", "income_metrics_place_all.qmd"),
    output_file = glue::glue("calculate-income-place-all-{years_place}.html"),
    execute_params = map(years_place, ~ list(year = .))
  )
...
reports <-
  tibble(
    input = here::here("03_opportunities-for-income", "income_metrics_county_all.qmd"),
    output_file = glue::glue("calculate-income-county-all-{years}.html"),
