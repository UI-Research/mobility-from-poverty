...
reports <-
  tibble(
    input = here::here("03_opportunities-for-income", "income_metrics_place_sub.qmd"),
    output_file = glue::glue("calculate-income-place-sub-{years}.html"),
...
reports <-
  tibble(
    input = here::here("03_opportunities-for-income", "income_metrics_county_sub.qmd"),
    output_file = glue::glue("calculate-income-county-sub-{years}.html"),
    execute_params = map(years, ~ list(year = .))
  )
