...
if (!file.exists(here::here("13_economic-inclusion/data/counties.csv"))) {
  counties_test <-
    map(years, ~ get_poverty_status_data(.x, "county")) |>
    list_rbind() |>
    relocate(year, .before = everything())

  write_csv(counties_test, here("13_economic-inclusion/data/counties.csv"))
}
```

```{r}
counties_test <- read_csv(here::here("13_economic-inclusion/data/counties.csv"))
...
write_csv(
  final_data,
  here::here("13_economic-inclusion", "final", "poverty-exposure_county.csv")
)
```
...
write_csv(
  ...
  here::here("13_economic-inclusion", "final", "poverty-exposure_race-ethnicity_county.csv")
)
```
...
final_county_data <- read_csv(here::here("13_economic-inclusion", "final", "poverty-exposure_county.csv"), show_col_types = FALSE)

evaluate_final_data(
  exp_form_path = "99a_final-evaluation/evaluation_form_exposure_poverty_overall_county.csv",
...
```{r}
final_county_data_subgroups <- read_csv(here::here("13_economic-inclusion/final/poverty-exposure_race-ethnicity_county.csv"), show_col_types = FALSE)


evaluate_final_data(
  exp_form_path = "99a_final-evaluation/evaluation_form_exposure_poverty_race_eth_county.csv",
