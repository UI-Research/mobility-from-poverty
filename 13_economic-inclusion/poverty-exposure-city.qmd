...
source(here::here("13_economic-inclusion", "R", "census_api_key.R"))
source(here::here("13_economic-inclusion", "R", "get_vars.R"))
```
...
if (!file.exists(here::here("13_economic-inclusion/data/tracts.csv"))) {
  tracts_raw <- map(years, ~ get_poverty_status_data(.x, geography = "tract")) |>
    list_rbind() |>
    relocate(year, .before = everything())

  if (!dir.exists(here::here("13_economic-inclusion/data"))) {
    dir.create(here::here("13_economic-inclusion/data"))
  }
  write_csv(tracts_raw, here("13_economic-inclusion/data/tracts.csv"))
}
```
...
tracts_raw <- read_csv(here::here("13_economic-inclusion/data/tracts.csv"))
```
...
knitr::include_graphics(here::here("13_economic-inclusion", "www", "images", "race.png"))
```
...
There are 485 observations through 2014-2018 and 486 after 2021
...
if (!file.exists(here::here("13_economic-inclusion/data/places.csv"))) {
  places_test <-
    map(years, ~ get_poverty_status_data(.x, "place")) |>
    list_rbind() |>
    relocate(year, .before = everything())

  write_csv(places_test, here("13_economic-inclusion/data/places.csv"))
}
```

```{r}
places_test <- read_csv(here::here("13_economic-inclusion/data/places.csv"))
...
write_csv(
  final_data,
  here::here("13_economic-inclusion", "final", "poverty-exposure_city.csv")
)
```
...
write_csv(
  ...
  here::here("13_economic-inclusion", "final", "poverty-exposure_race-ethnicity_city.csv")
)
```
...
final_city_data <- read_csv(here::here("13_economic-inclusion", "final", "poverty-exposure_city.csv"), show_col_types = FALSE)

evaluate_final_data(
  exp_form_path = "99a_final-evaluation/evaluation_form_exposure_poverty_overall_city.csv",
...
```{r}
final_city_data_subgroups <- read_csv(here::here("13_economic-inclusion/final/poverty-exposure_race-ethnicity_city.csv"), show_col_types = FALSE)


evaluate_final_data(
  exp_form_path = "99a_final-evaluation/evaluation_form_exposure_poverty_race_eth_city.csv",
