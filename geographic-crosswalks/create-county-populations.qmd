...
date: today
abstract: "This script pulls US Census Bureau Population Estimation Program and Decennial Census data to create a list of counties with population estimates for 2014-2024"
format: 
  html:
    toc: true
...
pep_2021_2024 <- pep_2021_2024 |>
  ...
  mutate(county_name = if_else(str_detect(county_name, "a Ana County"), "Doña Ana County",
                                       county_name))
...
SOme county names have excess white spaces. 
...
We need counties for 2025 but skip adding the population, which isn't available yet. 
