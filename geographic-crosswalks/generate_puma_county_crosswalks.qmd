...
```{r}
write_csv(puma_county20, here::here("geographic-crosswalks", "data", "puma_to_county_2020.csv"))
write_csv(puma_county10, here::here("geographic-crosswalks", "data", "puma_to_county_2010.csv"))
```
