...
```{r}
write_csv(puma_place20, here::here("geographic-crosswalks", "data", "puma_to_place_2020.csv"))
write_csv(puma_place10, here::here("geographic-crosswalks", "data", "puma_to_place_2010.csv"))
```
