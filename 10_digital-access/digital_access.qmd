...
export_metric <- function(data, type = c("subgroup", "multi-year")) {
  ...
  if (type == "multi-year") {
    write_csv(
      data,
      here::here("10_digital-access", "final", glue("digital_access_{geo}_all.csv"))
    )
    ...
    write_csv(
      data,
      here::here("10_digital-access", "final", glue("digital_access_{geo}_subgroup_all.csv"))
    )
  } else {
...
county_all <- read_csv(here::here("10_digital-access/final/digital_access_county_all.csv"))
county_subgroup <- read_csv(here::here("10_digital-access/final/digital_access_county_subgroup_all.csv"))
...
place_all <- read_csv(here::here("10_digital-access/final/digital_access_city_all.csv"))
place_subgroup <- read_csv(here::here("10_digital-access/final/digital_access_city_subgroup_all.csv"))
