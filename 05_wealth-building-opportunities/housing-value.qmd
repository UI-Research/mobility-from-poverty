...
if(length(fs::dir_ls(here::here("05_wealth-building-opportunities", "data"), glob = "*.xml")) == 0){
...
fs::dir_create(here("05_wealth-building-opportunities/data"))

filepath <- download_extract(usa_ext_complete,
  download_dir = here("05_wealth-building-opportunities/data")
)
}
...
acs1yr_raw <-
  read_ipums_micro(here(glue("05_wealth-building-opportunities/data/{microdata}"))) |>
  janitor::clean_names() |>
  rename(
    ownership = ownershp,
    state = statefip,
...
export_metric <- function(data, file_type) {
  ...
  output_path <- here(glue("05_wealth-building-opportunities/final/households_house_value_race_ethnicity_{file_type}_{geography}.csv"))
...
county_all <- read_csv(here::here("05_wealth-building-opportunities", "final", "households_house_value_race_ethnicity_all_county.csv"))
...
county_subgroup <- read_csv(here::here("05_wealth-building-opportunities", "final", "households_house_value_race_ethnicity_subgroup_county.csv"))
...
```{r}
place_all <- read_csv(here::here("05_wealth-building-opportunities", "final", "households_house_value_race_ethnicity_all_city.csv"))
...
All files saved to `05_wealth-building-opportunities/final/`:
...
```{r}
final_county_data <- read_csv(here::here("05_wealth-building-opportunities/final/households_house_value_race_ethnicity_all_county.csv"), show_col_types = FALSE)

final_place_data <- read_csv(here::here("05_wealth-building-opportunities/final/households_house_value_race_ethnicity_all_city.csv"), show_col_types = FALSE)
evaluate_final_data(
...
final_county_data_subgroups <- read_csv(here::here("05_wealth-building-opportunities/final/households_house_value_race_ethnicity_subgroup_county.csv"), show_col_types = FALSE)

final_place_data_subgroups <-
  read_csv(here::here("05_wealth-building-opportunities/final/households_house_value_race_ethnicity_subgroup_city.csv"), show_col_types = FALSE)
