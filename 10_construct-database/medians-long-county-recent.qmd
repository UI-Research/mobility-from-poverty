...
Calculate medians -- need to add subgroup weighting to this
...
metrics_recent_suppressed <- metrics_long_recent |> 
  ...
  select(year, pillar, name, weighted_median, low_pctle, high_pctle, black_median, hispanic_median, white_median, share_lq3) 
