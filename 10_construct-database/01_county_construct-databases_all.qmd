...
bind_rows(
  read_csv(here("01_financial-well-being", "metrics_income.csv")),
  read_csv(here("01_financial-well-being", "metrics_income_2021.csv"))
) %>%
  write_csv(here("data", "temp", "metrics_income_combined.csv"))
...
bind_rows(
  read_csv(here("09_employment", "metrics_employment.csv")),
  read_csv(here("09_employment", "metrics_employment_2021.csv")) %>%
    rename(employed_quality = share_employed_quality)
) %>%
  write_csv(here("data", "temp", "metrics_employment.csv"))
...
files <- c(
  ...
  here("data", "temp", "metrics_income_combined.csv"),
  ...
  ### WORK ###
  here("data", "temp", "metrics_employment.csv"),
