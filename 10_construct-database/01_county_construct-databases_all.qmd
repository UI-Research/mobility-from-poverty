...
home_val_ratios <- read_csv(here("01_financial-well-being", "home-values", "county_hh_hw_raceeth_2014_2021.csv")) %>%
  mutate(r_black_nh_hv_hh = ifelse(r_black_nh_hv_hh == "NaN%:NaN%", NA, r_black_nh_hv_hh),
         black_nh_wealth_quality = ifelse(r_black_nh_hv_hh == "NaN%:NaN%", NA, black_nh_wealth_quality), 
         
         r_hispanic_hv_hh = ifelse(r_hispanic_hv_hh == "NaN%:NaN%", NA, r_hispanic_hv_hh),
         hispanic_wealth_quality = ifelse(r_hispanic_hv_hh == "NaN%:NaN%", NA, hispanic_wealth_quality), 

         r_white_nh_hv_hh = ifelse(r_white_nh_hv_hh == "NaN%:NaN%", NA, r_white_nh_hv_hh),
         white_nh_wealth_quality = ifelse(r_white_nh_hv_hh == "NaN%:NaN%", NA, white_nh_wealth_quality), 

         r_other_nh_hv_hh = ifelse(r_other_nh_hv_hh == "NaN%:NaN%", NA, r_other_nh_hv_hh),
         other_nh_wealth_quality = ifelse(r_other_nh_hv_hh == "NaN%:NaN%", NA, other_nh_wealth_quality) 
         ) %>%
