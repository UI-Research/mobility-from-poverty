...
read_csv(here("01_financial-well-being", "data", "final", "metrics_income_county_all_longitudinal.csv")) %>%
  filter(year < 2022) %>%
  write_csv(here("data", "temp", "metrics_income_county_all_longitudinal.csv"))

read_csv(here("09_employment", "data", "final", "metrics_employment_county_all_longitudinal.csv")) %>%
  filter(year < 2022) %>%
  write_csv(here("data", "temp", "metrics_employment_county_all_longitudinal.csv"))  
...
files <- c(
  ...
  here("data", "temp", "metrics_income_county_all_longitudinal.csv"),
  ...
  ### WORK ###
  here("data", "temp", "metrics_employment_county_all_longitudinal.csv"),
