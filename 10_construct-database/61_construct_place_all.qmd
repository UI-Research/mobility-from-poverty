...
```{r}
# clean up data
# RP: Don't think this update Manu notes is needed as data isn't supposed to be generated for overall debt and medical debt at place-level:
...
# Ridhi: Can't locate file "02_housing/data/final/homelessness_2014-2018_city.csv" which needs to be added
...
filepaths <- c(
  ...
  # 02 housing
  here("data", "temp", "homelessness_city_all.csv"),
  here("02_housing/data/final/housing_place_2014_2015_2016_2017_2018_2019_2021_2022_2023.csv"),
  # 04 health
  ...
  # RP: Needs to be updated/checked
