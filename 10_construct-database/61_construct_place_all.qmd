...
```{r}
# clean up data
# MA: need to add/update to "01_financial-well-being/city-debt-coll-shares-2023.csv"
...
# MA: need to update to race-ethnicity-exposure-city.csv
...
# MA: Not finding this in the tracker
bind_rows(
...
# MA: This is now "02_housing/data/final/homelessness_2019-2022_city.csv"
bind_rows(
...
filepaths <- c(
  ...
  # MAK: This now is housing_place_2014_2015_2016_2017_2018_2019_2021_2022_2023.csv
  ...
  # MAK: transportation_all_city.csv
...
db <- db |>
  rename(
    ...
    ratio_high_low_ses_fb_friends = share_economic_connectedness,
    ratio_high_low_ses_fb_friends_quality = share_economic_connectedness_quality
  )
```
