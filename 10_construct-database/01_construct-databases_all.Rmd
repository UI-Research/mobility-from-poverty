...
files <- c(
  ...
  here("06_neighborhoods", "environment", "county_level_enviro.csv"),
  ...
  here("07_safety", "juvenile_arrests", "jvarrestrate_county_2016.csv"),
...
db_values %>%
  ...
  assert(within_bounds(0, 100), haz_idx) %>%
...
```{r}
write_csv(db_recent, here("10_construct-database", "mobility-metrics.csv"))
