...
# Ridhi: confused about this metric files
#bind_rows(
...
filepaths <- c(
  ...
  # Ridhi: Can't find the file at the location
...
```{r}
# Ridhi: This assertion fails for years 2015 through 2021, should I add back whatever counties are missing?
# db |> 
#   count(year) |>
#   assert(
...
```{R}
# Ridhi: Update once homeless metric finalized
db |>
  # assert(
  #   within_bounds(0, Inf),
  #   count_homeless,
