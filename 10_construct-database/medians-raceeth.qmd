...
metrics_recent_suppressed_01 <- metrics_01_recent_final |> 
  ...
  select(year, name, subgroup, weighted_median, low_pctle, high_pctle, share_lq3) 
...
metrics_recent_suppressed_01 <- metrics_recent_suppressed_01 |>
  ...
  select(pillar, name, subgroup, year, weighted_median, low_pctle, high_pctle, share_lq3)
