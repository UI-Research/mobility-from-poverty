...
calc_year_subgroup_table <- function(metrics_df, table_caption) {
...
calc_year_subgroup_table(metrics_01, "01_Metrics Table") |>    
  datatable()
...
calc_year_subgroup_table(metrics_01, "01_Metrics Table") |>
  ...
  labs(
    title = "County Race-Ethnicity Medians",
    x = "Share NA or Quality==3"
  )

calc_year_subgroup_table(metrics_02, "02_Metrics Table") |>    
  datatable()
...
calc_year_subgroup_table(metrics_02, "02_Metrics Table") |>
  ...
  geom_point(alpha = 0.3) +
  labs(
    title = "County Race Medians",
    x = "Share NA or Quality==3"
  )

calc_year_subgroup_table(metrics_03, "03_Metrics Table") |>    
  datatable()
...
calc_year_subgroup_table(metrics_03, "03_Metrics Table") |>
  ...
  geom_point(alpha = 0.3) +
  labs(
    title = "County Race-Share Medians",
    x = "Share NA or Quality==3"
  )

calc_year_subgroup_table(poverty_02, "02_Poverty Table") |>    
  datatable()
...
calc_year_subgroup_table(poverty_02, "02_Poverty Table") |>
  ...
  geom_point(alpha = 0.3) +
  labs(
    title = "County Race-Ethnicty Medians (2nd)",
    x = "Share NA or Quality==3"
  )
