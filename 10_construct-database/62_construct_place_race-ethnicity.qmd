...
```{r}
# RP: I think code to update homelessness can be deleted as this metric was recalculated
# Quality NA and variable mismatch
# read_csv(here("02_housing/data/final/homelessness_2019-2022_subgroups_city.csv")) |>
#   mutate(
#     share_homeless_quality = ifelse(is.na(share_homeless), NA_character_, share_homeless_quality),
...
# RP: Need to update/delete based on final data availability
# # Correct geography
...
# RP: Double check this but Vincent fixed this in the PR so this can be removed when data is available
...
filepaths <- c(
  ...
  here("08_education/data/final/digital_access_place_race_ethnicity_longitudinal.csv"),
...
```{R}
# RP: Un-comment and update when data becomes available
# db_race_eth |>
#   assert(
#     within_bounds(0, Inf),
#     count_homeless,
