...
The following table describes the quality of the data for the communities of interest. There are 27 metrics because some of the metrics contain multiple variables. For example, the race-ethnicity exposure metrics have variables for white non-Hispanic, Black non-Hispanic, and Hispanic. Most variables for most communities have "Good" quality. 
