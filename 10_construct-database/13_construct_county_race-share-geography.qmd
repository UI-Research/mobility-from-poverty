...
read_csv(here("data", "temp", "county_debt_longitudinal_race-ethnicity.csv")) |>
  mutate(subgroup = case_when(subgroup == "Majority White" ~ "Majority White, Non-Hispanic",
                              subgroup == "No Majority Race/Ethnicity" ~ "Mixed Race and Ethnicity", 
                              subgroup == "Majority Non-White" ~ "Majority Households of Color",
                              TRUE ~ subgroup),
...
read_csv(here("06_neighborhoods/environment/data/final/environment_county_race-ethnicity_longitudinal.csv")) |>
  mutate(subgroup = case_when(subgroup == "No Majority Race/Ethnicity" ~ "Mixed Race and Ethnicity", 
                              subgroup == "Majority Non-White" ~ "Majority Households of Color",
                              TRUE ~ subgroup)) |>
  write_csv(
...
read_csv(here("06_neighborhoods/Transportation/final/transit_trips_all_subgroups_county.csv")) |>
  mutate(subgroup = case_when(subgroup == "Majority Non-White Tracts" ~ "Majority Households of Color", 
...
expand_grid(
  read_csv(here("geographic-crosswalks", "data", "county-populations.csv")),
           subgroup = c("All", "Majority Households of Color", "Majority White, Non-Hispanic", 
